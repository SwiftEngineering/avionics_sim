...
double US_1976_atmosphere::get_temperature_K(const double geopot_height) {
  ...
  const double Lmb = lapse_rate[static_cast<size_t>(layer)];
  const double Tmb = base_temp[static_cast<size_t>(layer)];
  const double Hb = base_geopot_height_km[static_cast<size_t>(layer)];
...
double US_1976_atmosphere::get_pressure_Pa(const double geopot_height) {
  ...
  const double Lmb = lapse_rate[static_cast<size_t>(layer)];
  const double Tmb = base_temp[static_cast<size_t>(layer)];
  const double Pb = base_pressure[static_cast<size_t>(layer)];
  const double Hb = base_geopot_height_km[static_cast<size_t>(layer)];
