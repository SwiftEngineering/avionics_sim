...
This is a new lift-drag plugin for Gazebo, and designed for easy porting to other simulators, such as Airsim.
...
## Lift Drag Model UML Class Diagram

###### Summary

The UML class diagram enummerates the properties and methods of the Lift Drag Model C++ class.

![Lift Drag Model UML diagram](images/Lift_Drag_Model_UML_Class_Diagram.png)
...
This is implemented in the code by obtaining the world pose and linear velocity of the link then storing it in the instance of the lift drag model.

![Set pose and velocity UML sequence diagram](images/UML_sequence_diagram_set_pose_and_velocity.png)
...
<u>*Calculate local velocities and wind angles sequence*</u>

![UML sequence diagram-calculateWindAnglesAndLocalVelocities](images/UML_sequence_diagram_cal_wind_angles_and_velocities.png)





<u>*calculateWindAnglesAndLocalVelocities logic diagram*</u>

![calculateWindAnglesAndLocalVelocities logic diagram](images/calculateWindAnglesAndLocalVelocities_logic.png)





<u>*calculateLocalVelocities logic diagram*</u>

![calculateLocalVelocities logic diagram](images/calculateLocalVelocities_logic.png)

<u>*calculateWindAngles logic diagram*</u>

![calculateWindAngles logic diagram](images/calculateWindAngles_logic.png)

<u>*Verification*</u>

With an input world pose having an orientation in radians of (0.0,0.0,0.0,-0.09,1.48.0.1) and a world velocity in meters per second of (0.9, 0.9, 9.9), the following values of $\alpha, \beta, V_{\infty}$ , and $V_{planar}$ were calculated using rotation matrices:
$$
V_{planar} = 10\\
V_{\infty} = 9.98\\
\alpha=4.7\\
\beta=5.2\\
$$
The lift drag model produces values equal to the values calculated by the rotation matrices within a maximum tolerance of 0.1.

![local velocities and wind angles unit test inputs](images/unit_test_inputs_local_velocity_and_wind_angles.png)

![local velocities and wind angles unit test results](images/unit_test_results_velocity_and_wind_angle_calculation.png)
