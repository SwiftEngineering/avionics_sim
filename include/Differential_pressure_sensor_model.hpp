...
class Differential_pressure_sensor_model {
  public:
    ...
    explicit Differential_pressure_sensor_model(const double pitot_correction) {
    ...
    /// \brief Convert differential pressure to indicated airspeed
    /// \details Assumes compressable flow, speed less than the speed of sound
    /// \param [in] indicated_airspeed  Indicated airspeed in m/s.
    /// \return                         Returns differential pressure in Pa.
    ...
    double corrected_airspeed_from_true_airspeed(const double true_airspeed, const double static_pressure,
    ...
    double diff_press_from_true_airspeed(const double true_airspeed, const double static_pressure,
                                         const double temperature_celsius);
