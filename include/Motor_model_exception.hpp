...
class Motor_model_exception: public AvionicsSimException {
 public:
  ...
  ///
  explicit Motor_model_exception(const char *message, bool _isCritical = false): AvionicsSimException(message,
        _isCritical) {
    msg_ = message;
  ...
  /// \return      Instance of exception class
  ///
  explicit Motor_model_exception(const std::string &message, bool _isCritical = false): AvionicsSimException(message,
        _isCritical) {
    msg_ = message;
    critical = _isCritical;
  }
