...
// class BatteryModelParamTest : public ::testing::TestWithParam<BatteryModelParams> {
//     static const double epislon = 1e-13;
// };

// const std::vector<BatteryModelParams> params{
//     {
//       "Test 1",
...
// INSTANTIATE_TEST_CASE_P(CBatteryModelTest,
//                          BatteryModelParamTest,
