...
TEST(US_1976_atmosphere_UnitTest, get_pressure) {
  ...
  EXPECT_NEAR(US_1976_atmosphere::get_pressure(71000.0), 	3.9564,
              5.0 * 0.0001); //precision loss, should be 0.0001
  EXPECT_NEAR(US_1976_atmosphere::get_pressure(77000.0), 	1.4809,
              5.0 * 0.0001); //precision loss, should be 0.0001

  EXPECT_NEAR(US_1976_atmosphere::get_pressure(84500.0),  0.39814,
...
TEST(US_1976_atmosphere_UnitTest, get_mass_density) {
  ...
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(5000.0),	7.3612e-1,
              0.0001e-1);


  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(11000.0), 	3.6392e-1,
              0.0001e-1);
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(15000.0), 	1.9367e-1,
              0.0001e-1);

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(20000.0), 	8.8035e-2,
              0.0001e-2);
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(25000.0), 	3.9466e-2,
              0.0001e-2);

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(32000.0), 	1.3225e-2,
              0.0001e-2);
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(40000.0), 	3.8510e-3,
              0.0001e-2);

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(47000.0), 	1.4275e-3,
              0.0001e-3);
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(49000.0), 	1.1090e-3,
              0.0001e-3);

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(51000.0), 	8.6160e-4,
              0.0001e-4);
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(61000.0), 	2.5355e-4,
              0.0001e-4);

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(71000.0), 	6.4211e-5,
              5.0 * 0.0001e-5);//precision loss, should be 0.0001e-5
  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(77000.0), 	2.5458e-5,
              5.0 * 0.0001e-5);//precision loss, should be 0.0001e-5

  EXPECT_NEAR(US_1976_atmosphere::get_mass_density(84500.0),	7.3914e-6,
